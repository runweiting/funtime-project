<template>
    ...
    <div class="m-3 m-lg-6">
        <div class="container py-3 p-lg-10" data-aos="fade-up">
            <div class="row">
    ...
    <div class="m-3 m-lg-6">
        <div class="container pt-10 px-5 pt-md-20" data-aos="fade-up">
            <div class="row row-cols-1 g-1 row-cols-md-2 my-3 my-lg-6 p-md-20">
                <div class="col d-flex flex-column justify-content-center text-center text-md-start">
    ...
    <!-- 最新企劃 -->
    <div class="m-3 m-lg-6">
        <div class="container bg-gray rounded-5 p-10 p-md-20" data-aos="fade-up">
    ...
    <div class="m-3 m-lg-6">
        <div class="container pt-10 px-5 pt-md-20" data-aos="fade-up">
            ...
            <div class="row row-cols-1 g-5 row-cols-md-2 row-cols-xl-3">
                <div class="col p-0 p-md-3">
