<template>
    ...
    <div class="mx-3 mx-lg-10">
        <div class="container px-lg-12">
            <div class="row px-md-2 px-lg-3 px-xl-4">
                <div class="col my-3 my-lg-6">
        ...
        <div class="container bg-light rounded-5 px-6 py-3 px-lg-12 px-xl-15">
            <div class="d-flex justify-content-center gap-12">
                <div class="d-flex align-items-center gap-4">
                    ...
                    <span style="letter-spacing: 10px;">確認品項</span>
                </div>
                <i class="bi bi-chevron-right"></i>
                <div class="d-flex align-items-center gap-4">
                    <i class="bi bi-check-circle-fill text-dark-secondary"></i>
                    <span style="letter-spacing: 10px;">填寫訂單</span>
                </div>
                <i class="bi bi-chevron-right"></i>
                <div class="d-flex align-items-center gap-4">
                    <i class="bi bi-check-circle-fill text-dark-secondary"></i>
                    <span style="letter-spacing: 10px;">交易結果</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container px-lg-12">
            <div class="row">
                <div class="col px-xl-4 my-3 my-lg-6">
                    ...
                    <div class="rounded-5 border border-5 border-info-light p-5 gap-3">
                        <div class="input-group">
                            <input type="text" class="form-control" aria-label="coupon_code" aria-describedby="coupon_code">
                            <button class="btn btn-secondary" type="button" id="coupon_code">套用優惠卷</button>
                        </div>
                    </div>
                </div>
