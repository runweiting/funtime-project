    ...
    <div class="container bg-light rounded-5 px-6 py-3 px-lg-12 px-xl-15 mb-3 mb-lg-6">
      <div class="row">
        <div class="col text-center">
          <small class="text-dark-gray" style="letter-spacing: 8px;">訂單詳細資訊</small>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row mb-5">
              <div class="col px-8">
                <div class="row row-cols-1 row-cols-md-2 align-items-center">
                  ...
                  <div class="col-md-5">
                    <div class="d-flex justify-content-center align-items-center gap-8 gap-md-4">
                      <img src="/dazzle-order-delivered.gif" alt="open-book-glasses-and-stars" class="object-fit-cover img-fluid w-50">
                      <div class="d-flex flex-column align-items-center justify-content-md-center align-items-md-center gap-2">
                  ...
                  <div class="text-end">
                    <div class="d-flex flex-column gap-4 justify-content-center">
                      <span class="fs-6 text-dark-gray responsive-lh-ls text-normal mb-0 text-center">
                        感謝您的支持和鼓勵！<br class="d-768-block">快去看看其他有趣的企劃吧～
                      </span>
